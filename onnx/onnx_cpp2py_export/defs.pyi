...
class OpSchema:
    ...
    def set_type_and_shape_inference_function(self, func: Callable[[InferenceContext], None]) -> None: ...
    def get_type_and_shape_inference_function(self) -> Callable[[InferenceContext], None]: ...
