...
TENSOR_TYPE_TO_NP_TYPE = DeprecatedWarningDict({tensor_dtype: value.np_type for tensor_dtype, value in TENSOR_TYPE_MAP.items()},
    "TENSOR_TYPE_TO_NP_TYPE", "tensor_dtype_to_np_typeto_storage_tensor_type")
# This is only used to get keys into STORAGE_TENSOR_TYPE_TO_FIELD.
# TODO(https://github.com/onnx/onnx/issues/4261): Remove this.

TENSOR_TYPE_TO_STORAGE_TENSOR_TYPE = DeprecatedWarningDict({tensor_dtype: value.storage_type for tensor_dtype, value in TENSOR_TYPE_MAP.items()},
    "TENSOR_TYPE_TO_STORAGE_TENSOR_TYPE", "tensor_dtype_to_storage_tensor_type")
...
NP_TYPE_TO_TENSOR_TYPE = DeprecatedWarningDict({v: k for k, v in TENSOR_TYPE_TO_NP_TYPE.items() if k != TensorProto.BFLOAT16},
