...
ReduceDocGenerator_opset13_18(const char* name, bool supports_8bit_datatypes, bool axes_input,
const char* func_body, ContextDependentFunctionBodyBuilder function_builder) {
