...
class ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 8, ExpandAs);
...
class ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 8, NE);
class ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 8, LE);
class ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 8, GE);
...
class OpSet_Onnx_ver8 {
 public:
  static void ForEachSchema(std::function<void(OpSchema&&)> fn) {
    ...
    fn(GetOpSchema<ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 8, ExpandAs)>());
    ...
    fn(GetOpSchema<ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 8, NE)>());
    fn(GetOpSchema<ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 8, LE)>());
    fn(GetOpSchema<ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 8, GE)>());
  }
};
