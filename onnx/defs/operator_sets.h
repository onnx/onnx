...
class ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 23, ScalarDotProductAttention);
...
class OpSet_Onnx_ver23 {
 public:
  static void ForEachSchema(const std::function<void(OpSchema&&)>& fn) {
    ...
    fn(GetOpSchema<ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 23, ScalarDotProductAttention)>());
