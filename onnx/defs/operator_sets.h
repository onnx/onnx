...
class ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 20, DynamicQuantizeLinear);
...
class OpSet_Onnx_ver20 {
 public:
  static void ForEachSchema(std::function<void(OpSchema&&)> fn) {
    ...
    fn(GetOpSchema<ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 20, DynamicQuantizeLinear)>());
