        ...
        for domain, supportmap in operator_schemas:
            ...
            for _, namemap in supportmap:
                for op_type, schema, versions in namemap:
                    ...
                    if schema.min_input < schema.max_input:
                        input_str = "({} - {}) ".format(display_number(schema.min_input),display_number(schema.max_input))
                    ...
                    if schema.min_output < schema.max_output:
                            input_str += ' ({} - {})'.format(display_number(schema.min_output), display_number(schema.max_output))
                    isFirstOut = True
                    ...
                    fout.write("|{}|{}|{}|{}|{}|\n".format(
                        format_name_with_domain(domain, op_link), 
                        input_str, output_str, tc_str, version_str))
