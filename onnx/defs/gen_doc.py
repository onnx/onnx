...
def main(args: Args) -> None:
    ...
    with open(
        ...
        # REUSE-IgnoreStart
        # We write an SPDX header into the generated changelog file. The
        # literal string would be picked up by the REUSE linter when scanning
        # this source file, so ignore this region for REUSE.
    ...
    with open(
        ...
        # REUSE-IgnoreStart
        # We write an SPDX header into the generated schema docs. See comment
        # above; ignore this literal for REUSE scanning.
        fout.write("<!--- SPDX-License-Identifier: Apache-2.0 -->\n")
        # REUSE-IgnoreEnd
