    ...
    OpSchema()
      ...
      .FunctionBody(FunctionBodyHelper::BuildNodes(
          {// nodes: {outputs, op, inputs, attributes}
           ...
           {{"X_Min"}, "ReduceMin", {"x"}, {MakeAttribute("keepdims", int64_t(0)), MakeRefAttribute("axis", AttributeProto::INTS), MakeAttribute("complement_axis", int64_t(1))}},
           {{"X_Min_Adjusted"}, "Min", {"X_Min", "Q_Min"}},
           {{"X_Max"}, "ReduceMax", {"x"}, {MakeAttribute("keepdims", int64_t(0)), MakeRefAttribute("axis", AttributeProto::INTS), MakeAttribute("complement_axis", int64_t(1))}},
