...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        ...
        .SetDoc(kDoc_QuantizeLinear_ver28)
...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    11,
    OpSchema()
        .SetDoc(kDoc_DynamicQuantizeLinear_ver11)
        ...
        .FunctionBody(R"ONNX(
        {
           ...
           X_Range_Is_Zero = Equal (X_Range, Q_Min)
           X_Range_Adjusted = Where (X_Range_Is_Zero, One, X_Range)
           Scale = Div (X_Range_Adjusted, Q_Max)
