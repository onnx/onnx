...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        ...
        .Attr(
            "axis",
            "(Optional) The axis of the quantization dimension of the input tensor. Negative value means counting dimensions from the back. Accepted range is [-r, r-1] where r = rank(input). If either y_zero_point or y_scale is a 1D tensor, then an axis must be specified. If both are scalars, axis is ignored.",
            AttributeProto::INT,
