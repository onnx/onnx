...
uint64_t StringStringEntryProto::SerializeSize(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  uint64_t size = 0;
  SIZE_FIELD(size, options, stream, key)
  SIZE_FIELD(size, options, stream, value)
  return size;
}
void StringStringEntryProto::SerializeToStream(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
...
} std::vector<std::string> StringStringEntryProto::PrintToVectorString(utils::PrintOptions& options) const {
  return {write_as_string(options, NAME_EXIST_VALUE(key), NAME_EXIST_VALUE(value))};
}

// TensorAnnotation
IMPLEMENT_PROTO(TensorAnnotation)
uint64_t TensorAnnotation::SerializeSize(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  uint64_t size = 0;
  SIZE_FIELD(size, options, stream, tensor_name)
  SIZE_REPEATED_FIELD(size, options, stream, quant_parameter_tensor_names)
  return size;
}
void TensorAnnotation::SerializeToStream(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
...
void TensorAnnotation::ParseFromStream(utils::BinaryStream& stream, ParseOptions& options){
  ...
  return write_proto_into_vector_string(
      options, NAME_EXIST_VALUE(tensor_name), NAME_EXIST_VALUE(quant_parameter_tensor_names));
}

// IntIntListEntryProto

IMPLEMENT_PROTO(IntIntListEntryProto)
uint64_t IntIntListEntryProto::SerializeSize(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  uint64_t size = 0;
  SIZE_FIELD(size, options, stream, key)
  SIZE_REPEATED_FIELD(size, options, stream, value)
  return size;
}
void IntIntListEntryProto::SerializeToStream(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  WRITE_FIELD(options, stream, key)
...
} std::vector<std::string> IntIntListEntryProto::PrintToVectorString(utils::PrintOptions& options) const {
...
uint64_t DeviceConfigurationProto::SerializeSize(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  uint64_t size = 0;
...
void DeviceConfigurationProto::SerializeToStream(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
...
} std::vector<std::string> DeviceConfigurationProto::PrintToVectorString(utils::PrintOptions& options) const {
  return write_proto_into_vector_string(
      options, NAME_EXIST_VALUE(name), NAME_EXIST_VALUE(num_devices), NAME_EXIST_VALUE(device));
}

// SimpleShardedDimProto

IMPLEMENT_PROTO(SimpleShardedDimProto)
uint64_t SimpleShardedDimProto::SerializeSize(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  uint64_t size = 0;
...
void SimpleShardedDimProto::SerializeToStream(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
...
} std::vector<std::string> SimpleShardedDimProto::PrintToVectorString(utils::PrintOptions& options) const {
  return write_proto_into_vector_string(
      options, NAME_EXIST_VALUE(dim_value), NAME_EXIST_VALUE(dim_param), NAME_EXIST_VALUE(num_shards));
}

// ShardedDimProto

IMPLEMENT_PROTO(ShardedDimProto)
uint64_t ShardedDimProto::SerializeSize(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  uint64_t size = 0;
  SIZE_FIELD(size, options, stream, axis)
  SIZE_REPEATED_FIELD(size, options, stream, simple_sharding)
  return size;
}
void ShardedDimProto::SerializeToStream(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
...
void ShardedDimProto::ParseFromStream(utils::BinaryStream& stream, ParseOptions& options){
  ...
  return write_proto_into_vector_string(options, NAME_EXIST_VALUE(axis), NAME_EXIST_VALUE(simple_sharding));
}

// ShardingSpecProto

IMPLEMENT_PROTO(ShardingSpecProto)
uint64_t ShardingSpecProto::SerializeSize(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  uint64_t size = 0;
  SIZE_FIELD(size, options, stream, tensor_name)
  SIZE_REPEATED_FIELD(size, options, stream, device)
...
void ShardingSpecProto::SerializeToStream(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  WRITE_FIELD(options, stream, tensor_name)
  WRITE_REPEATED_FIELD(options, stream, device)
...
uint64_t NodeDeviceConfigurationProto::SerializeSize(utils::BinaryWriteStream& stream, SerializeOptions& options)
    const {
  uint64_t size = 0;
...
void NodeDeviceConfigurationProto::SerializeToStream(utils::BinaryWriteStream& stream, SerializeOptions& options)
    const {
...
} std::vector<std::string> NodeDeviceConfigurationProto::PrintToVectorString(utils::PrintOptions& options) const {
  return write_proto_into_vector_string(
      options, NAME_EXIST_VALUE(configuration_id), NAME_EXIST_VALUE(sharding_spec), NAME_EXIST_VALUE(pipeline_stage));
}
...
uint64_t TensorShapeProto::Dimension::SerializeSize(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  uint64_t size = 0;
  SIZE_FIELD(size, options, stream, dim_value)
  SIZE_FIELD(size, options, stream, dim_param)
...
void TensorShapeProto::Dimension::SerializeToStream(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  WRITE_FIELD(options, stream, dim_value)
  WRITE_FIELD(options, stream, dim_param)
...
} std::vector<std::string> TensorShapeProto::Dimension::PrintToVectorString(utils::PrintOptions& options) const {
  return write_proto_into_vector_string(
      options, NAME_EXIST_VALUE(dim_value), NAME_EXIST_VALUE(dim_param), NAME_EXIST_VALUE(denotation));
}

// TensorShapeProto

IMPLEMENT_PROTO(TensorShapeProto)
uint64_t TensorShapeProto::SerializeSize(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  uint64_t size = 0;
  SIZE_REPEATED_FIELD(size, options, stream, dim)
  return size;
}
void TensorShapeProto::SerializeToStream(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
...
uint64_t TensorProto::Segment::SerializeSize(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  uint64_t size = 0;
  SIZE_FIELD(size, options, stream, begin)
  SIZE_FIELD(size, options, stream, end)
  return size;
}
void TensorProto::Segment::SerializeToStream(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
...
} std::vector<std::string> TensorProto::Segment::PrintToVectorString(utils::PrintOptions& options) const {
...
void TensorProto::SerializeToStream(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  ...
  if (has_data_location() && ref_data_location() == DataLocation::EXTERNAL && stream.ExternalWeights()) {
    ...
    for (size_t i = 0; i < ref_external_data().size(); ++i) {
      ...
      if (entry.ref_key() == "location") {
        ...
        EXT_ENFORCE(
            size == static_cast<int64_t>(ref_raw_data().size()),
            "Size mismatch ",
            size,
            " != ",
            static_cast<int64_t>(ref_raw_data().size()),
            " name='",
            ref_name().as_string(),
            "'");
        checked += 2;
        ...
        EXT_ENFORCE(
            offset == two_stream.weights_size(),
            "Offset mismatch ",
            offset,
            " != ",
            two_stream.weights_size(),
            " name ='",
            ref_name().as_string(),
            "'");
        checked += 4;
...
void TensorProto::ParseFromStream(utils::BinaryStream& stream, ParseOptions& options) {
  ...
  if (has_data_location() && ref_data_location() == DataLocation::EXTERNAL && stream.ExternalWeights()) {
    ...
    EXT_ENFORCE(
        offset >= 0 && size > 0,
        "External data offset and size must be specified, name='",
        ref_name().as_string(),
        "'");
...
std::vector<std::string> TensorProto::PrintToVectorString(utils::PrintOptions& options) const {
  return write_proto_into_vector_string(
      ...
      NAME_EXIST_VALUE(data_type),
      NAME_EXIST_VALUE(data_location),
      NAME_EXIST_VALUE(name),
      NAME_EXIST_VALUE(segment),
      NAME_EXIST_VALUE(raw_data),
      NAME_EXIST_VALUE(doc_string),
      NAME_EXIST_VALUE(external_data),
      NAME_EXIST_VALUE(metadata_props),
      NAME_EXIST_VALUE(double_data),
      NAME_EXIST_VALUE(float_data),
      NAME_EXIST_VALUE(int32_data),
      NAME_EXIST_VALUE(int64_data),
      NAME_EXIST_VALUE(uint64_data),
...
uint64_t SparseTensorProto::SerializeSize(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  uint64_t size = 0;
...
void SparseTensorProto::SerializeToStream(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
...
void SparseTensorProto::ParseFromStream(utils::BinaryStream& stream, ParseOptions& options){
  ...
  return write_proto_into_vector_string(
      options, NAME_EXIST_VALUE(values), NAME_EXIST_VALUE(indices), NAME_EXIST_VALUE(dims));
}

// TypeProto::Tensor

IMPLEMENT_PROTO(TypeProto::Tensor)
uint64_t TypeProto::Tensor::SerializeSize(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  uint64_t size = 0;
  SIZE_FIELD(size, options, stream, elem_type)
  SIZE_OPTIONAL_PROTO_FIELD(size, options, stream, shape)
  return size;
}
void TypeProto::Tensor::SerializeToStream(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
...
uint64_t TypeProto::SparseTensor::SerializeSize(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  uint64_t size = 0;
  SIZE_FIELD(size, options, stream, elem_type)
  SIZE_OPTIONAL_PROTO_FIELD(size, options, stream, shape)
  return size;
}
void TypeProto::SparseTensor::SerializeToStream(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  WRITE_FIELD(options, stream, elem_type)
  WRITE_OPTIONAL_PROTO_FIELD(options, stream, shape)
}
...
} std::vector<std::string> TypeProto::SparseTensor::PrintToVectorString(utils::PrintOptions& options) const {
  return write_proto_into_vector_string(options, NAME_EXIST_VALUE(elem_type), NAME_EXIST_VALUE(shape));
}
...
uint64_t TypeProto::Sequence::SerializeSize(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  uint64_t size = 0;
  SIZE_OPTIONAL_PROTO_FIELD(size, options, stream, elem_type)
  return size;
}
void TypeProto::Sequence::SerializeToStream(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
...
} std::vector<std::string> TypeProto::Sequence::PrintToVectorString(utils::PrintOptions& options) const {
...
uint64_t TypeProto::Map::SerializeSize(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  uint64_t size = 0;
  SIZE_FIELD(size, options, stream, key_type)
  SIZE_OPTIONAL_PROTO_FIELD(size, options, stream, value_type)
  return size;
}
void TypeProto::Map::SerializeToStream(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
...
void TypeProto::Map::ParseFromStream(utils::BinaryStream& stream, ParseOptions& options){
  ...
  return write_proto_into_vector_string(options, NAME_EXIST_VALUE(key_type), NAME_EXIST_VALUE(value_type));
}

// TypeProto::Optional

IMPLEMENT_PROTO(TypeProto::Optional)
uint64_t TypeProto::Optional::SerializeSize(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  uint64_t size = 0;
  SIZE_OPTIONAL_PROTO_FIELD(size, options, stream, elem_type)
  return size;
}
void TypeProto::Optional::SerializeToStream(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  WRITE_OPTIONAL_PROTO_FIELD(options, stream, elem_type)
}
...
void TypeProto::ParseFromStream(utils::BinaryStream& stream, ParseOptions& options){
  ...
  return write_proto_into_vector_string(
      options,
      NAME_EXIST_VALUE(tensor_type),
      NAME_EXIST_VALUE(sequence_type),
      NAME_EXIST_VALUE(map_type),
...
uint64_t ValueInfoProto::SerializeSize(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  uint64_t size = 0;
  SIZE_FIELD(size, options, stream, name)
...
void ValueInfoProto::SerializeToStream(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  WRITE_FIELD(options, stream, name)
...
uint64_t AttributeProto::SerializeSize(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  uint64_t size = 0;
  SIZE_FIELD(size, options, stream, name)
...
void AttributeProto::SerializeToStream(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  WRITE_FIELD(options, stream, name)
  ...
  switch (type_) {
    ...
    default:
      return write_proto_into_vector_string(
          options,
          NAME_EXIST_VALUE(name),
          NAME_EXIST_VALUE(ref_attr_name),
          NAME_EXIST_VALUE(doc_string),
          NAME_EXIST_VALUE(type),
          NAME_EXIST_VALUE(f),
          NAME_EXIST_VALUE(i),
          NAME_EXIST_VALUE(s),
          NAME_EXIST_VALUE(t),
          NAME_EXIST_VALUE(sparse_tensor),
          NAME_EXIST_VALUE(g),
          NAME_EXIST_VALUE(floats),
          NAME_EXIST_VALUE(ints),
          NAME_EXIST_VALUE(strings),
          NAME_EXIST_VALUE(tensors),
          NAME_EXIST_VALUE(sparse_tensors),
          NAME_EXIST_VALUE(graphs),
          NAME_EXIST_VALUE(tp));
  }
}
...
void NodeProto::ParseFromStream(utils::BinaryStream& stream, ParseOptions& options){
  ...
  return write_proto_into_vector_string(
      options,
      NAME_EXIST_VALUE(input),
      NAME_EXIST_VALUE(output),
      NAME_EXIST_VALUE(name),
      NAME_EXIST_VALUE(op_type),
      NAME_EXIST_VALUE(attribute),
      NAME_EXIST_VALUE(domain),
      NAME_EXIST_VALUE(overload),
      NAME_EXIST_VALUE(doc_string),
      NAME_EXIST_VALUE(metadata_props),
...
void GraphProto::ParseFromStream(utils::BinaryStream& stream, ParseOptions& options){
  ...
  return write_proto_into_vector_string(
      ...
      NAME_EXIST_VALUE(output),
      NAME_EXIST_VALUE(metadata_props),
      NAME_EXIST_VALUE(node),
      NAME_EXIST_VALUE(initializer),
      NAME_EXIST_VALUE(sparse_initializer),
      NAME_EXIST_VALUE(value_info),
...
uint64_t FunctionProto::SerializeSize(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  uint64_t size = 0;
  SIZE_FIELD(size, options, stream, name)
  SIZE_REPEATED_FIELD(size, options, stream, input)
  SIZE_REPEATED_FIELD(size, options, stream, output)
...
void FunctionProto::SerializeToStream(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  WRITE_FIELD(options, stream, name)
  WRITE_REPEATED_FIELD(options, stream, input)
  WRITE_REPEATED_FIELD(options, stream, output)
  WRITE_REPEATED_FIELD(options, stream, attribute)
...
void FunctionProto::ParseFromStream(utils::BinaryStream& stream, ParseOptions& options){
  ...
  return write_proto_into_vector_string(
      ...
      NAME_EXIST_VALUE(input),
      NAME_EXIST_VALUE(output),
      NAME_EXIST_VALUE(opset_import),
      NAME_EXIST_VALUE(attribute),
      NAME_EXIST_VALUE(attribute_proto),
      NAME_EXIST_VALUE(node),
      NAME_EXIST_VALUE(value_info),
      NAME_EXIST_VALUE(metadata_props));
}
...
void ModelProto::ParseFromStream(utils::BinaryStream& stream, ParseOptions& options){
  ...
  return write_proto_into_vector_string(
      options,
      NAME_EXIST_VALUE(ir_version),
      NAME_EXIST_VALUE(opset_import),
      NAME_EXIST_VALUE(producer_name),
      NAME_EXIST_VALUE(producer_version),
      NAME_EXIST_VALUE(domain),
      NAME_EXIST_VALUE(model_version),
      NAME_EXIST_VALUE(doc_string),
      NAME_EXIST_VALUE(graph),
      NAME_EXIST_VALUE(metadata_props),
      NAME_EXIST_VALUE(functions),
