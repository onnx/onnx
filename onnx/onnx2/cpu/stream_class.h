...
#define FIELD(type, name, order, doc)                       \
 public:                                                    \
  ...
  inline bool has_##name() const {                          \
    return _has_field_(name##_);                            \
  }                                                         \
  inline void set_##name(const type& v) {                   \
    name##_ = v;                                            \
  }                                                         \
  inline int order_##name() const {                         \
    return order;                                           \
  }                                                         \
...
#define FIELD_STR(name, order, doc)                   \
  ...
  inline void set_##name(const utils::RefString& v) { \
    name##_ = v;                                      \
  }

#define FIELD_REPEATED(type, name, order, doc)                  \
 public:                                                        \
  inline utils::RepeatedField<type>& ref_##name() {             \
    return name##_;                                             \
  }                                                             \
  ...
  inline bool has_##name() const {                              \
    return _has_field_(name##_) && !name##_.empty();            \
  }                                                             \
  inline int order_##name() const {                             \
    return order;                                               \
  }                                                             \
