...
class AveragePool(Base):
  ...
  def export():
    ...
    expect(node, inputs=[x], outputs=[y], name='test_averagepool')
    ...
    expect(node, inputs=[x], outputs=[y], name='test_averagepool_same_lower')
    ...
    expect(node, inputs=[x], outputs=[y], name='test_averagepool_pads')
