...
class AveragePool(Base):
    ...
    @staticmethod
    def export_averagepool_2d_same_upper_count_include_pad():  # type: () -> None
        """
        iutput_shape: [1, 3, 32, 32]
        output_shape: [1, 3, 32, 32]
        pad_shape: [1, 1] -> [0, 1, 0, 1] by axis
        ...
        expect(node, inputs=[x], outputs=[y], name='test_averagepool_2d_same_upper_count_include_pad')
    ...
    @staticmethod
    def export_averagepool_2d_same_lower_count_include_pad():  # type: () -> None
        """
        iutput_shape: [1, 3, 32, 32]
        output_shape: [1, 3, 32, 32]
        pad_shape: [1, 1] -> [1, 0, 1, 0] by axis
        ...
        expect(node, inputs=[x], outputs=[y], name='test_averagepool_2d_same_lower_count_include_pad')
