...
class ScalarDotProductAttention(Base):
    ...
    @staticmethod
    def export_scalar_dot_product_attention_with_present() -> None:
        node = onnx.helper.make_node(
            "ScalarDotProductAttention",
            inputs=["Q", "K", "V", "attn_mask"],
            outputs=["output", "present_key", "present_value"],
    ...
    @staticmethod
    def export_scalar_dot_product_attention_gqa_with_present() -> None:
        node = onnx.helper.make_node(
            "ScalarDotProductAttention",
            inputs=["Q", "K", "V", "attn_mask"],
            outputs=["output", "present_key", "present_value"],
    ...
    @staticmethod
    def export_scalar_dot_product_attention_diff_head_sizes_with_present() -> None:
        node = onnx.helper.make_node(
            "ScalarDotProductAttention",
            inputs=["Q", "K", "V", "attn_mask"],
            outputs=["output", "present_key", "present_value"],
    ...
    @staticmethod
    def export_scalar_dot_product_attention_3d_with_present() -> None:
        q_num_heads, kv_num_heads = 3, 3
        node = onnx.helper.make_node(
            "ScalarDotProductAttention",
            inputs=["Q", "K", "V", "attn_mask"],
    ...
    @staticmethod
    def export_scalar_dot_product_attention_3d_gqa_with_present() -> None:
        q_num_heads, kv_num_heads = 9, 3
        node = onnx.helper.make_node(
            "ScalarDotProductAttention",
            inputs=["Q", "K", "V", "attn_mask"],
    ...
    @staticmethod
    def export_scalar_dot_product_attention_3d_diff_head_sizes_with_present() -> None:
        q_num_heads, kv_num_heads = 3, 3
        node = onnx.helper.make_node(
            "ScalarDotProductAttention",
            inputs=["Q", "K", "V", "attn_mask"],
