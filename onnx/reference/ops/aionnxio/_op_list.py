...
from onnx.reference.ops.aionnxio._op_run_aionnxio import OpRunAiOnnxIo
from onnx.reference.ops.aionnxio.op_image_decoder import ImageDecoder


def _build_registered_operators() -> Dict[str, Dict[Union[int, None], OpRunAiOnnxIo]]:
...
_registered_operators: TOptional[
    Dict[str, Dict[Union[int, None], OpRunAiOnnxIo]]
] = None
