...
class DefaultVersionConverter : public BaseVersionConverter {
 ...
 public:
  DefaultVersionConverter() {
    ...
    /******** 26 -> 27 ********/
    registerAdapter(std::make_unique<CompatibleAdapter>("DepthToSpace", OpSetID(26), OpSetID(27)));
    registerAdapter(std::make_unique<CompatibleAdapter>("SpaceToDepth", OpSetID(26), OpSetID(27)));

    /******** 27 -> 26 ********/
    registerAdapter(std::make_unique<CompatibleAdapter>("DepthToSpace", OpSetID(27), OpSetID(26)));
    registerAdapter(std::make_unique<CompatibleAdapter>("SpaceToDepth", OpSetID(27), OpSetID(26)));
  }
