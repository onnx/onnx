...
class TestShapeInference(unittest.TestCase):
    ...
    def test_unfoldtodepth_padding(self):  # type: () -> None
        graph = self._make_graph(
            ...
            [make_node('UnfoldToDepth', ['x'], 'y', block_shape=[2, 2], pads=[1, 1, 1, 1], strides=[1, 1])],
            [])
    ...
    def test_unfoldtodepth_no_padding(self):  # type: () -> None
        graph = self._make_graph(
            ...
            [make_node('UnfoldToDepth', ['x'], 'y', block_shape=[3, 3])],
            [])
    ...
    def test_unfoldtodepth_padding_stride(self):  # type: () -> None
        graph = self._make_graph(
            ...
            [make_node('UnfoldToDepth', ['x'], 'y', block_shape=[3, 3], pads=[2, 2, 2, 2], strides=[3, 3])],
            [])
