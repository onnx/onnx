...
VERSION_TABLE: VersionTableType = [
    # Release-version, IR version, ai.onnx version, ai.onnx.ml version, (optional) ai.onnx.training version, (optional) ai.onnx.pnp version
    ("1.0", 3, 1, 1),
    ("1.1", 3, 5, 1),
    ("1.1.2", 3, 6, 1),
    ("1.2", 3, 7, 1),
...
def create_op_set_id_version_map(table: VersionTableType) -> VersionMapType:
    ...
    def process(release_version: str, ir_version: int, *args: Any) -> None:
        ...
        for pair in zip(["ai.onnx", "ai.onnx.ml", "ai.onnx.training", "ai.onnx.pnp"], args):
