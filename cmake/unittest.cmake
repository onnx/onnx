...
set(UT_NAME ${PROJECT_NAME}_tests)
...
target_link_libraries(${UT_NAME} PRIVATE Catch2::Catch2WithMain)
...
if(ONNX_GENERATE_TEST_REPORTS)
  ...
  list(
      APPEND
        TEST_ARGS
        "--reporter junit --out $<SHELL_PATH:$<TARGET_FILE:${UT_NAME}>.$<CONFIG>.results.xml>")
endif()
